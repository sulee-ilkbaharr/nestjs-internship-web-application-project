...
exports.InternshipsModule = InternshipsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([Internship_entity_1.Internship]), auth_module_1.AuthModule],
        controllers: [internship_controller_1.InternshipController],
        providers: [internships_repository_1.InternshipRepository, internships_service_1.InternshipsService],
    })
], InternshipsModule);
